...
| 目录 | 主题/备注 |
|------|----------|
| [`yuki_morning_battle/craft_trial`](episodes/yuki_morning_battle/craft_trial/) | 6.4s 二维修型试片：手型、四肢曲线与迈步落地；用户认可效果明显改善，罗圈腿留待后续修正。[制作记录与运行命令](episodes/yuki_morning_battle/VISUAL_REVIEW.md) |
