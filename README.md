...
| 目录 | 主题/备注 |
|------|----------|
| [`cat_leads_e08_drifting_page/hybrid`](episodes/cat_leads_e08_drifting_page/hybrid/) | 《漂走的那张画》60s 混合三维重制：小蓝/阿澈五指与连续四肢、18 镜河岸运镜、风与飞鸟，复制原绘制版音轨并校验一致。[制作说明](episodes/cat_leads_e08_drifting_page/hybrid/NOTES.md) |
