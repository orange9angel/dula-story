...
| 目录 | 主题/备注 |
|------|----------|
| [`yuki_morning_battle/craft_trial`](episodes/yuki_morning_battle/craft_trial/) | 保留 6.4s 二维基线；12.4s 三维四肢修正、手势、迈步与 360° 转台，立体手掌已按用户反馈补成五指，提供四手势 × 四视角近景。[制作记录与运行命令](episodes/yuki_morning_battle/VISUAL_REVIEW.md) |
