...
- `episodes/yuki_morning_battle/craft_trial/` — 《早起大作战》二维修型试片（6.4s、1080p/30fps、无声；三维卧室 + 关节驱动二维小雪；手势与迈步、对比版/单独版、交互 viewer；2026-09-21 用户认可“效果好非常多”，罗圈腿仍为 P1 待后续修正，当前只同步；入口与复现见该集 `VISUAL_REVIEW.md`）
