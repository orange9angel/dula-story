"""V19: calibrate lyric timing against the V19 vocal stem.

calibrate_v12 with V19 paths (stems_v19 + mixed_v19_base). The sha cross-check
...
def calibrate(music):
    ...
    assert sep['source_sha256'] == digest(base), 'stems_v19 并非分离自 mixed_v19_base'
...
if __name__ == '__main__':
    m = json.loads((ROOT / 'config/music_analysis_v19.json').read_text(encoding='utf-8'))
