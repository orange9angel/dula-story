"""V18: known-lyrics Whisper DTW alignment on the V18 separated vocal.

align_v10 with the V18 stem path and cache file. Character alignment, not
...
def main():
    ...
    target = ROOT / 'config/lyrics_forced_alignment_v18.json'
