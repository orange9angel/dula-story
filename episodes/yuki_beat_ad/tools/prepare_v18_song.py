"""V18 step 1: master the new song (candidate_d) and separate its stems.
...
SOURCE = ROOT / 'assets/audio/music/v18/candidate_d.wav'
BASE = ROOT / 'assets/audio/mixed_v18_base.wav'
STEMS = ROOT / 'assets/audio/stems_v18'
...
def build_base():
    ...
    shutil.copyfile(BASE, ROOT / 'assets/audio/music/mixed_v18_base.wav')
    print(f'V18 base master: {duration}s -> {BASE.name}')
    return duration
