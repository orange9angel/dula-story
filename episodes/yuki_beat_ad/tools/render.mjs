...
const version = v12 ? 'v12' : v11 ? 'v11' : v10 ? 'v10' : v9 ? 'v9' : v8 ? 'v8' : v6 ? 'v6' : v5 ? 'v5' : v4 ? 'v4' : v3 ? 'v3' : v2 ? 'v2' : '';
...
const fps = v3 || v4 || v5 || v6 || v8 || v9 || v10 || v11 || v12 ? 60 : 30;
...
if (!serveOnly) {
  ...
  try {
    ...
    for(let i=0;i<Math.round(duration*fps);i++) {
      ...
      if(v10 || v11 || v12) performanceTrace.push({frame:i,...(capture?result.state:result)});
      if(capture) {
    ...
    if(v10 || v11 || v12) fs.writeFileSync(path.join(boardDir,'performance_trace.json'),JSON.stringify({duration,fps,frames:performanceTrace}));
