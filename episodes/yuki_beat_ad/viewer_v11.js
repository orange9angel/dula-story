...
import { buildDanceRig, poseDance, createLipDriver, applyLips, actFace, drawMotif } from './performance_v11.js';
...
await board.load('/episode/script_v11.story','/episode/assets/audio/manifest.json');
...
if(!new URLSearchParams(location.search).has('capture')){
  const audio=new Audio('/episode/assets/audio/mixed_v11.wav');audio.loop=true;
