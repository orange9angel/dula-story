...
SHOTS = [
    ("shot01_girl_path", "frame_01", "002_Girl", 2.6, 0.2,
     "少女走在河边小径上，保持姿势和位置完全不动，只有嘴部随说话开合；视线落在画面右下方的猫身上，眉毛轻挑，语气轻快好奇。"),
    ...
    ("shot03_oldman_hello", "frame_09", "006_OldMan", 3.9, 0.2,
     "老渔夫坐在柳树下的小马扎上，回头看向画面右侧，保持姿势和位置完全不动，只有嘴部随说话开合；笑眼眯起，眉毛舒展，语气热络慢悠悠。"),
    ...
    ("shot07_oldman_proud", "frame_16", "011_OldMan", 3.9, 0.2,
     "老渔夫拍了拍身边的竹竿，保持姿势和位置完全不动，只有嘴部随说话开合；眉毛上扬，眼睛笑成缝，语气得意爽朗。"),
    ("shot08_oldman_mystery", "frame_18", "012_OldMan", 4.3, 0.2,
     "老渔夫望着河面，保持姿势和位置完全不动，只有嘴部随说话开合；眉头微蹙，眼神变得悠远，语速明显放慢放低，带着一点神秘。"),
    ...
    ("shot10_cat_deflect", "frame_23", "016_Cat", 2.0, 0.2,
     "橘猫回过头，保持姿势和位置完全不动，只有嘴部随声音极轻微动一下；眼睑低垂，神情刻意平静，像什么都没发生。"),
]
