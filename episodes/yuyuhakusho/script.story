...
{Event:Face|character=Yusuke|target=Kuwabara}
{Event:Face|character=Kuwabara|target=Yusuke}
[Kuwabara]{FaceReset}{SpiritSwordDraw}{FaceDetermined}{Camera:TwoShot|characterA=Yusuke|characterB=Kuwabara|distance=10} 幽助！下次我一定会打败你的！

20
00:01:13,500 --> 00:01:17,500
{Event:Face|character=Yusuke|target=Kuwabara}
{Event:Face|character=Kuwabara|target=Yusuke}
[Yusuke]{FaceReset}{CrossArms}{FaceSmirk}{Camera:TwoShot|characterA=Yusuke|characterB=Kuwabara|distance=8} 哼...别得意忘形了。下次可不会手下留情。
