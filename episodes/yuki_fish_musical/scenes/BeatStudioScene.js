...
import {buildTheatre} from '../theatre.js';

export class BeatStudioScene extends SceneBase {
  constructor() { super('BeatStudioScene'); }
  initializeTheatre(cat) {
    this.theatre=buildTheatre(this.scene,cat);
    this.emptyDish=this.theatre.dish;
    this.crumbs=this.theatre.evidence;
    this.dishes=this.theatre.plates;
    this.mochiHead=cat.headGroup;
    return this.theatre;
  }
  build() {
