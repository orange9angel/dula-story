...
# recording scheduled at timelineStart. Entries 3, 7 and 12 are the SFX-only
# SRT cues in script.story (6.2s windowsill meow, 17.6s steps meow, 44.0s
# parapet meow).
SFX_CUES = [
    {"index": 3, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 6.2},
    {"index": 7, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 17.6},
    {"index": 12, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 44.0},
]
