...
MUSIC_PATH = OUTPUT_DIR / "music" / "morning_guitar_lesfm_11157.mp3"
...
def build_bgm_bus() -> None:
    # Envelope: quiet bed under the room/street/store acts, a swell that
    # reaches full gain at the closing line (storyboard beat at 51.3 s), a
