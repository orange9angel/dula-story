...
# SFX-driven mouth cues for non-dialogue sounds (cat meows). These are not on
# the dialogue bus; their 12 fps cells are energy-gated straight from the SFX
# recording scheduled at timelineStart. Index 22 is the SFX-only SRT entry
# carrying the meow that betrays the girl's hiding spot at 80.2 s.
SFX_CUES = [
    {"index": 22, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 80.2},
]
...
PINYIN_BY_CHAR = {
    "雨": "yu", "停": "ting", "以": "yi", "后": "hou", "小": "xiao",
    "橘": "ju", "就": "jiu", "在": "zai", "我": "wo", "家": "jia",
    "住": "zhu", "下": "xia", "了": "le", "每": "mei", "天": "tian",
    "上": "shang", "学": "xue", "前": "qian", "它": "ta", "都": "dou",
    "要": "yao", "送": "song", "到": "dao", "门": "men", "口": "kou",
    "乖": "guai", "看": "kan", "晚": "wan", "给": "gei", "你": "ni",
    "带": "dai", "鱼": "yu", "干": "gan", "可": "ke", "是": "shi",
    "最": "zui", "近": "jin", "总": "zong", "望": "wang", "着": "zhe",
    "窗": "chuang", "外": "wai", "像": "xiang", "等": "deng", "谁": "shei",
    "又": "you", "跑": "pao", "出": "chu", "去": "qu", "户": "hu",
    "开": "kai", "一": "yi", "条": "tiao", "缝": "feng", "这": "zhe",
    "伙": "huo", "已": "yi", "经": "jing", "第": "di", "三": "san",
    "次": "ci", "刚": "gang", "才": "cai", "那": "na", "底": "di",
    "哪": "na", "儿": "er", "啊": "a", "慢": "man", "点": "dian",
    "呀": "ya", "巷": "xiang", "子": "zi", "尽": "jin", "头": "tou",
    "河": "he", "堤": "di", "居": "ju", "然": "ran", "直": "zhi",
    "接": "jie", "过": "guo", "们": "men", "班": "ban", "转": "zhuan",
    "生": "sheng", "吗": "ma", "个": "ge", "猫": "mao", "哇": "wa",
    "画": "hua", "全": "quan", "嗯": "en", "明": "ming", "见": "jian",
    "知": "zhi", "道": "dao", "心": "xin", "里": "li", "装": "zhuang",
    "路": "lu", "不": "bu", "止": "zhi", "今": "jin", "也": "ye",
    "来": "lai", "啦": "la", "吃": "chi", "新": "xin", "的": "de",
    "哦": "o", "咦": "yi", "还": "hai", "朋": "peng", "友": "you",
    "候": "hou", "喏": "nuo", "月": "yue", "台": "tai", "对": "dui",
    "面": "mian", "想": "xiang", "吧": "ba", "时": "shi", "会": "hui",
}
...
def build(episode_dir: Path) -> dict:
    ...
    for cue in SFX_CUES:
        sfx_path = episode_dir / "assets" / "audio" / "sfx" / f"{cue['sfx']}.wav"
        sfx_rate, sfx_samples = read_pcm16_mono(sfx_path)
        sfx_duration = len(sfx_samples) / sfx_rate
        frames = build_envelope(sfx_samples, sfx_rate)
        energy_cells = quantize_energy_cells(frames, sfx_duration)
        start_time = float(cue["timelineStart"])
        output_entries.append(
            {
                "index": int(cue["index"]),
                ...
                "timelineStart": round(start_time, 4),
                "timelineEnd": round(start_time + sfx_duration, 4),
                "sourceDuration": round(sfx_duration, 6),
                "sourceOffset": 0.0,
                "effectiveDuration": round(sfx_duration, 6),
                "alignment": "energy-gated-sfx-v1",
                "syllables": ["miao"],
                "audibleSegments": audible_segments(energy_cells, start_time),
                "energyCells": energy_cells,
                "cells": energy_cells[:],
