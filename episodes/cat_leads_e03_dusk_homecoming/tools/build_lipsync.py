...
# recording scheduled at timelineStart. Entries 3, 8 and 12 are the SFX-only
# SRT cues in script.story (6.6s bank meow, 26.0s bridge-end meow, 40.6s wall
# silhouette meow).
SFX_CUES = [
    {"index": 3, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 6.6},
    {"index": 8, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 26.0},
    {"index": 12, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 40.6},
]
