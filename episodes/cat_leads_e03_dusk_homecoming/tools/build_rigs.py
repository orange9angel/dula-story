...
MOUTH_RIGS = {  # rig name -> (base frame, story entry)
    ...
    "girl_frame04_entry5": ("frame_04", 5),
    "girl_frame06_entry7": ("frame_06", 7),
    "girl_frame11_entry11": ("frame_11", 11),
    "girl_frame16_entry16": ("frame_16", 16),
    "cat_frame02_meow": ("frame_02", 3),
    "cat_frame08_meow": ("frame_08", 8),
    "cat_frame12_meow": ("frame_12", 12),
}
...
def main() -> None:
    ...
    (EP / "config" / "mouth_rigs.json").write_text(json.dumps({
        ...
        "notes": ("Only the tight mouth rectangle is copied from generated variants; "
                  ...
                  "driven by SFX cue energy (SRT entries 3, 8 and 12 are the SFX-only "
                  "meow cues)."),
        "rigs": mouth_rigs,
