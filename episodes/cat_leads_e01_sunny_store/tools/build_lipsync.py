...
# recording scheduled at timelineStart. Entries 3 and 7 are the SFX-only SRT
# cues in script.story (5.8s windowsill meow, 23.4s store-door meow).
SFX_CUES = [
    {"index": 3, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 5.8},
    {"index": 7, "character": "Cat", "dialogue": "", "sfx": "cat_meow", "timelineStart": 23.4},
]
