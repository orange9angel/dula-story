...
@RoomScene{Music:Play|name=room_theme|fadeIn=1.0|baseVolume=0.6|endTime=50.0}
...
@ParkScene{Transition:Fade|duration=1.0}{Music:Play|name=park_theme|fadeIn=1.5|baseVolume=0.7|endTime=50.0}
{Position:Doraemon|x=-3|z=2|face=center}{Position:Nobita|x=3|z=2|face=center}{Position:Shizuka|x=0|z=5|face=center}
[Shizuka]{WaveHand}{Camera:Static|position=0,3,8|lookAt=0,1.5,0} 你们来啦！这里的草地好舒服呢！

8
00:00:33,000 --> 00:00:38,000
[Nobita]{FlyPose}{Camera:Shake|intensity=0.2} 哇——！我要第一个冲进海里——！
