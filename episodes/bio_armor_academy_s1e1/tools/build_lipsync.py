...
# SFX-driven mouth cues for non-dialogue sounds. This episode has no
# SFX-voiced character (no cat meows or similar): every mouth rig is driven
# by a spoken dialogue entry, so the table is intentionally empty.
SFX_CUES: list[dict] = []
...
PINYIN_BY_CHAR = {
    ...
    "家": "jia",
    "吧": "ba",
    # --- Bio-Armor Academy S1E1 additions (every spoken Han character in
    # --- script.story not already covered by the template table above).
    "三": "san",
    "上": "shang",
    "东": "dong",
    "中": "zhong",
