...
/**
 * Registry adapter for the speaker whose visible performance is already baked
...
export class GirlBakedSpeaker extends BakedSpeaker {
  constructor() {
    super('Girl');
  }
}

export class CatBakedSpeaker extends BakedSpeaker {
  constructor() {
    super('Cat');
  }
}
...
export class OldManBakedSpeaker extends BakedSpeaker {
  constructor() {
    super('OldMan');
  }
}
