...
// E06《模特小橘》 daytime post layers. Per STYLE_BIBLE.md every procedural
...
function parseStory(storyText) {
  ...
  if (!(duration > 0)) {
    throw new Error('CatPortraitSequenceScene could not read a positive duration from script.story');
  }
 ...
 * the E06《模特小橘》 daytime variant of the E03 keyframe-cel renderer.
 *
 ...
 * stay deterministic.
 */
export class CatPortraitScene extends SceneBase {
  constructor() {
    super('CatPortraitScene');
    this.timeline = [];
  ...
  build() {
    ...
    this.sequenceTexture.name = 'CatPortraitSequenceTexture';
