...
{SFX:Procedural|type=red_alert_pulse|start=0|end=4|volume=0.4}
...
{SFX:Procedural|type=water_drip_echo|start=0|end=${duration}|volume=0.35|density=0.4}
{SFX:Procedural|type=neon_buzz|start=0|end=${duration}|volume=0.18}
...
{SFX:Procedural|type=gunfight|start=0|end=3|volume=0.45|density=0.8}
...
{SFX:Procedural|type=radio_click|start=0|end=0.5|volume=0.5}
...
{SFX:Procedural|type=engine_idle|start=0|end=8|volume=0.25}
